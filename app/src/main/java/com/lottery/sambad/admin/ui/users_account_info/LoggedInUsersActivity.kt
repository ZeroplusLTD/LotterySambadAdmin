...
class LoggedInUsersActivity : AppCompatActivity() {
    ...
    private lateinit var binding: ActivityLoggedInUsersBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding= ActivityLoggedInUsersBinding.inflate(layoutInflater)
        ...
        supportActionBar?.title = "Logged In"
    ...
    private fun loadDuplicateLotteryNumber() {
        Coroutines.main {
            try {
                ...
                val response=viewModel.getUsersList(page_number.toString(),item_count.toString(),"6")

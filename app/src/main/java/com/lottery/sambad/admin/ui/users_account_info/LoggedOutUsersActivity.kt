...
class LoggedOutUsersActivity : AppCompatActivity() {
    private lateinit var binding: ActivityLoggedOutUsersBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding= ActivityLoggedOutUsersBinding.inflate(layoutInflater)
        ...
        supportActionBar?.title = "Logged Out"
    ...
    private fun loadDuplicateLotteryNumber() {
        Coroutines.main {
            try {
                ...
                val response=viewModel.getUsersList(page_number.toString(),item_count.toString(),"5")

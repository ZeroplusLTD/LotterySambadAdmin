...
import com.lottery.sambad.admin.databinding.ActivityExpireLicenseUsersBinding
import com.lottery.sambad.admin.databinding.ActivityLoggedInUsersBinding
...
class ExpireLicenseUsersActivity : AppCompatActivity() {

    private lateinit var binding: ActivityExpireLicenseUsersBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding= ActivityExpireLicenseUsersBinding.inflate(layoutInflater)
        ...
        supportActionBar?.title = "Expired license"
    ...
    private fun loadDuplicateLotteryNumber() {
        Coroutines.main {
            try {
                ...
                val response=viewModel.getUsersList(page_number.toString(),item_count.toString(),"3")

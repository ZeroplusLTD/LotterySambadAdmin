...
class PremiumUsersActivity : AppCompatActivity() {
    private lateinit var binding: ActivityPremiumUsersBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding= ActivityPremiumUsersBinding.inflate(layoutInflater)
    ...
    private fun loadDuplicateLotteryNumber() {
        Coroutines.main {
            try {
                ...
                val response=viewModel.getUsersList(page_number.toString(),item_count.toString(),"1")

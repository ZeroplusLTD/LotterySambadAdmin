...
import com.lottery.sambad.admin.databinding.ActivityPremiumUsersBinding
import com.lottery.sambad.admin.databinding.ActivityStanderdUsersBinding
...
class StanderdUsersActivity : AppCompatActivity() {
    private lateinit var binding: ActivityStanderdUsersBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding= ActivityStanderdUsersBinding.inflate(layoutInflater)
        ...
        supportActionBar?.title = "Standerd"
    ...
    private fun loadDuplicateLotteryNumber() {
        Coroutines.main {
            try {
                ...
                val response=viewModel.getUsersList(page_number.toString(),item_count.toString(),"2")
